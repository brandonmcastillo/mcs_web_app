...
export default function AboutUs() {
    return (
        <>
            ...
            <SplitContentLeft title="Kickboxing" subtitle="Learn the basics of punches, kicks, knees and elbos while learning skills to defend yourself in real life situations." />
            <SplitContentRight title="Filipino Escrima / Stickfighting" subtitle="Learn FMA (Filipino Martial Arts) skills that emphasizs sticks, blads, knives and other bladed weaponry." />
