          ...
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            >
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">Getting Started</p>
                ...
                <nav class="mt-8">
                  <ul class="space-y-4 text-sm">
                    ...
                    <li>
                      <a class="text-white transition hover:text-white/75" href="/instructor">
                        Instructor
                      </a>
                    </li>
                    <li>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">School Hours</p>
                ...
                <nav class="mt-8">
                  <ul class="space-y-4 text-sm">
                    ...
                    <li>
                      <a class="text-white transition hover:text-white/75" href="https://secure.rec1.com/CA/american-canyon-ca/catalog">
                        Register
                      </a>
                    </li>
                  </ul>
              ...
              <div class="text-center sm:text-left">
                ...
                <nav class="mt-8">
                  <ul class="space-y-4 text-sm">
                    <li>
                      <a class="text-white transition hover:text-white/75" href="/support#faqs">
                        FAQs
                      </a>
                    </li>

                    <li>
                      <a class="text-white transition hover:text-white/75" href="/support#registration">
                        Register / Billing
                      </a>
                    </li>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">Have a question?</p>

                <ul class="mt-8 space-y-4 text-sm">
                  <li>
                    <a
                      class="flex items-center justify-center sm:justify-start gap-1.5 group"
                      href="mailto:mixedcombativesystems@gmail.com"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span class="text-white transition group-hover:text-white/75">
                        mixedcombativesystems@gmail.com
                      </span>
                    </a>
                  </li>
                  ...
                  >
                    ...
                    <address class="-mt-0.5 not-italic text-white">
                      2193 Elliott Dr, American Canyon, CA 94503
                    </address>
                  </li>
                  {/* <li
                    class="flex items-start justify-center gap-1.5 sm:justify-start"
                  >
                    ...
                    <address class="-mt-0.5 not-italic text-white">
                      100 Benton Way
                      American Canyon, CA 94503 (Billing)
                    </address>
                  </li>
                  <li>
                    <a
          ...
          <div class="pt-6 mt-12 border-t border-gray-800">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
              <p class="text-sm text-gray-400">
                <span class="block sm:inline">Developed by Brandon Castillo</span>
              </p>
